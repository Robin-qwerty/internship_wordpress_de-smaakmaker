...
function register_gerechten_post_type() {
    $labels = array(
        'name'               => 'Gerechten',
        'singular_name'      => 'Gerecht',
        'menu_name'          => 'Gerechten',
        'add_new'            => 'Nieuw gerecht',
        'add_new_item'       => 'Nieuw gerecht toevoegen',
        'edit_item'          => 'Gerecht bewerken',
        'new_item'           => 'Nieuw gerecht',
        'view_item'          => 'Bekijk gerecht',
        'search_items'       => 'Zoek gerechten',
        'not_found'          => 'Geen gerechten gevonden',
        'not_found_in_trash' => 'Geen gerechten gevonden in prullenbak'
    );
...
add_action('init', 'register_gerechten_post_type'); 